			...
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<form action = "modifyOk.do" method = "post" name = "reg_frm">
					...
					<div class="form-group">
						아이디 : <input type = "text" name = "id" size = "20" value = "SNS 유저" readonly /> <br>
					</div>
					<div class="form-group">
						비밀번호 : <input type = "password" name = "pw" size = "20" value = "somethingspecial" readonly><br>
					</div>
					<div class="form-group">
						비밀번호 확인 : <input type = "password" name = "pw_check" size = "20" value = "somethingspecial" readonly><br>
					</div>
					<div class="form-group">
