		...
		<form action ="modify.nc" method = "post">
			...
			<tr>
				<td colspan = "2">
					...
					<input class = "btn btn-primary form-control" type = "button" value = "취소" onclick = "location.href='content_view.nc?bId=${content_view.bId}'"> &nbsp;&nbsp;
					<input class = "btn btn-primary form-control" type = "button" value = "목록보기" onclick = "location.href='list.nc?page=<%= session.getAttribute("cpage") %>'">
				</td>			
			</tr>
		</form>		
	</table>
