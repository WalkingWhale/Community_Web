...
<body>
	...
	<table class = "table table-bordered">
		...
		<tr>				
			<td><a href ='download.data?bId=${content_view.bId}'>${content_view.fileName}</a></td>
		</tr>
	</table>
	...
	<div class = "wrapper">
		<ul class="horizontal-menu">
			...
			<li>      			
        		<a href = "like.data?bId=${content_view.bId}">좋아요</a>
	    	</li>
	    	<li>
	    		<a href = "report.data?bId=${content_view.bId }">신고</a>
	    	</li>
    		<% } %>
    		<c:if test="${content_view.bUser == sessionScope.id}">
    		<li>
        		<a href = "modify_view.data?bId=${content_view.bId}">수정</a>
	    	</li>
	    	</c:if>
	    	<c:if test="${content_view.bUser == sessionScope.id || sessionScope.admin != null}">
    		<li>
        		<a href = "delete.data?bId=${content_view.bId}">삭제</a>
	    	</li>
	    	</c:if>
     	</ul>
	</div>
